          ...
          <form action="" οnsubmit="return false">
              <div class="form-content">
                  ...
                  <div class="form-line">
                      ...
                      <input v-model="username" class="input-data shadow" type="text" name="user-name" placeholder="请输入您的用户名">
                  </div>
                  <div class="form-line">
                  ...
                  <div class="form-line">
                      ...
                      <input class="input-data shadow" type="password"  placeholder="请确认您的密码">
                  </div>
                  <div class="form-line">
                  ...
                  <div class="form-line login">
                      <button class="lgbt" type='button' @touchstart="handleToRegister">注册</button>
                  </div>
              </div>
          </form>
