<template>
  <a href="suqiqi.cn" target="_blank">
  ...
  <section class="error">
    ...
    <div class="error__content">
      <div class="error__message message">
        <h1 class="message__title">暂无数据</h1>
        <p class="message__text">现在还没有收藏的电影数据，请先登录收藏哦！</p>
      </div>
      <div class="error__nav e-nav">
        <a href="suqiqi.cn" target="_blanck" class="e-nav__link"></a>
      </div>
    </div>
    <!-- END Content -->
