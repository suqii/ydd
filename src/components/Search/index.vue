    ...
    <div class="search_body">
        ...
        <div class="search_result">
            ...
            <ul>
                ...
                <li v-for="item in moviesList" :key="item.id" @click="handleToDetail(item.id)">
...
export default {
    ...
    watch : {
        message(newVal){
            ...
            this.cancelRequest();
            this.axios.get('/api/api/search?cityId='+ cityId +'&kw='+newVal,{
...
.search_body .search_result .info p:nth-of-type(1) span:nth-of-type(2){ font-size: 16px; color:#7219d6;}
</style>
